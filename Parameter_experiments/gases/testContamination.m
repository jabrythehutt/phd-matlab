function [data ] = testContamination(atmflag,molsToTest,allMols,lblArgs,prof,fileName )
...
if exist('fileName','var')==0
    fileName = ['Contamination_',datestr(now,'dd-mm-yy_HH-MM-SS'),'.mat'];
end
...
for i = 1:length(molIndices)
    ...
    molTestConfig = false(size(molTestConfig));
    
    molTestConfig(molIndex)=true;
